...
/* Void background */
.prism-app { display: flex; height: 100vh; overflow: hidden; position: relative; background: url('/void.jpg') calc(50% + 0.5cm) center / cover no-repeat fixed; background-color: #020510; }
